...
def main():
    ...
    for file in json_files:
        with open(file, "r") as f:
            ...
            score = len(set(model_response.split()).intersection(
                set(expected_answer))) / len(expected_answer)
    ...
    plt.title(f'NIAH {model_name_} \n Overall Score: {df["Score"].mean():.3f}')  # Adds a title
