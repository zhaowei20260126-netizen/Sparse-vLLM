...
def benchmark_task(method, length, bs, args, results_dict):
    ...
    elif method in ("streamingllm", "attention-sink", "attention_sink", "snapkv", "pyramidkv", "omnikv", "quest", "deltakv", "attnpredict", "attnpredict-offload"):
...
def main():
    ...
    parser.add_argument(
        ...
        help="Methods to test (vanilla, streamingllm, attention-sink, snapkv, pyramidkv, omnikv, quest, attnpredict, attnpredict-offload, deltakv, deltakv-triton, deltakv-triton-v2, deltakv-triton-v3, deltakv-triton-v3-offload, deltakv-triton-v3-cuda-offload)",
    )
