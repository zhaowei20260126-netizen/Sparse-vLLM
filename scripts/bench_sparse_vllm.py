...
def benchmark_task(method, length, bs, args, results_dict):
    ...
    elif method in ("snapkv", "pyramidkv", "omnikv", "quest", "deltakv"):
...
def main():
    ...
    parser.add_argument(
        ...
        help="Methods to test (vanilla, snapkv, pyramidkv, omnikv, quest, deltakv, deltakv-triton, deltakv-triton-v2, deltakv-triton-v3, deltakv-triton-v3-offload, deltakv-triton-v3-cuda-offload)",
    )
